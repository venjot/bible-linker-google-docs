...
const tagalogBibleBooks = new BibleLanguage("Tagalog", "tl", [
  new BibleBook(1, "Genesis", "Gen", "Gen.", false),
  new BibleBook(2, "Exodo", "Ex", "Ex.", false),
  new BibleBook(2, "", "Exo.", "", false),
  new BibleBook(3, "Levitico", "Lev", "Lev.", false),
  new BibleBook(4, "Bilang", "Bil", "Bil.", false),
  new BibleBook(5, "Deuteronomio", "Deut", "Deu", false),
  new BibleBook(5, "", "Deut.", "", false),
  new BibleBook(6, "Josue", "Jos", "Jos.", false),
  new BibleBook(7, "Hukom", "Huk", "Huk.", false),
  new BibleBook(8, "Ruth", "Ru", "Ru.", false),
  ...
  new BibleBook(15, "Ezra", "Ezr", "Ezr.", false),
  new BibleBook(16, "Nehemias", "Neh", "Ne", false),
  new BibleBook(16, "", "Neh.", "", false),
  new BibleBook(17, "Esther", "Es", "Es.", false),
  new BibleBook(18, "Job", "Job", "", false),
  new BibleBook(19, "Awit", "Aw", "Aw.", false),
  new BibleBook(20, "Kawikaan", "Kaw", "Kaw.", false),
  new BibleBook(21, "Eclesiastes", "Ecles", "Ec", false),
  new BibleBook(21, "", "Ecles.", "", false),
  new BibleBook(22, "Awit ni Solomon", "Sol", "Sol.", false),
  new BibleBook(23, "Isaias", "Isa", "Isa.", false),
  new BibleBook(24, "Jeremias", "Jer", "Jer.", false),
  new BibleBook(25, "Panaghoy", "Panag.", "Pan", false),
  new BibleBook(26, "Ezekiel", "Ezek", "Eze", false),
  new BibleBook(26, "", "Ezek.", "", false),
  new BibleBook(27, "Daniel", "Dan", "Dan.", false),
  new BibleBook(28, "Oseas", "Os", "Os.", false),
  new BibleBook(29, "Joel", "Joe", "Joe.", false),
  new BibleBook(30, "Amos", "Am", "Am.", false),
  new BibleBook(31, "Obadias", "Ob", "Ob.", true),
  new BibleBook(32, "Jonas", "Jon", "Jon.", false),
  new BibleBook(33, "Mikas", "Mik", "Mik.", false),
  new BibleBook(34, "Nahum", "Na", "Na.", false),
  new BibleBook(35, "Habakuk", "Hab", "Hab.", false),
  new BibleBook(36, "Zefanias", "Zef", "Zef.", false),
  new BibleBook(37, "Hagai", "Hag", "Hag.", false),
  new BibleBook(38, "Zacarias", "Zac", "Zac.", false),
  new BibleBook(39, "Malakias", "Mal", "Mal.", false),
  new BibleBook(40, "Mateo", "Mat", "Mat.", false),
  new BibleBook(41, "Marcos", "Mar", "Mar.", false),
  new BibleBook(42, "Lucas", "Luc", "Luc.", false),
  new BibleBook(43, "Juan", "Ju", "Ju.", false),
  new BibleBook(44, "Gawa", "Gaw", "Gaw.", false),
  new BibleBook(45, "Roma", "Rom.", "Ro", false),
  new BibleBook(45, "", "Rom.", "", false),
  new BibleBook(46, "1 Corinto", "1 Cor.", "1Co", false),
  new BibleBook(47, "2 Corinto", "2 Cor.", "2Co", false),
  new BibleBook(48, "Galacia", "Gal", "Gal.", false),
  new BibleBook(49, "Efeso", "Efe", "Efe.", false),
  new BibleBook(50, "Filipos", "Fil", "Fil.", false),
  new BibleBook(51, "Colosas", "Col", "Col.", false),
  ...
  new BibleBook(56, "Tito", "Tit", "Tit.", false),
  new BibleBook(57, "Filemon", "Flm", "Flm.", true),
  new BibleBook(58, "Hebreo", "Heb", "Heb.", false),
  new BibleBook(59, "Santiago", "Sant", "San", false),
  new BibleBook(59, "", "Sant.", "", false),
  new BibleBook(60, "1 Pedro", "1 Ped.", "1Pe", false),
  new BibleBook(61, "2 Pedro", "2 Ped.", "2Pe", false),
  new BibleBook(62, "1 Juan", "1Ju.", "1Ju", false),
  new BibleBook(63, "2 Juan", "2Ju.", "2Ju", true),
  new BibleBook(64, "3 Juan", "3Ju.", "3Ju", true),
  new BibleBook(65, "Judas", "Jud", "Jud.", true),
  new BibleBook(66, "Apocalipsis", "Apoc", "Apo", false),
  new BibleBook(66, "", "Apoc.", "", false),
]);

const spanishBibleBooks = new BibleLanguage("Spanish", "es", [
  new BibleBook(1, "Génesis", "Gé", "Gén.", false),
  new BibleBook(2, "Éxodo", "Éx", "Éx.", false),
  new BibleBook(3, "Levítico", "Le", "Lev.", false),
  new BibleBook(4, "Números", "Nú", "Núm.", false),
  new BibleBook(5, "Deuteronomio", "Dt", "Deut.", false),
  new BibleBook(6, "Josué", "Jos", "Jos.", false),
  new BibleBook(7, "Jueces", "Jue", "Juec.", false),
  ...
  new BibleBook(13, "1 Crónicas", "1 Crón.", "", false),
  new BibleBook(14, "2 Cronica", "2Cr", "", false),
  new BibleBook(14, "2 Crónicas", "2 Crón.", "", false),
  new BibleBook(15, "Esdras", "Esd.", "", false),
  new BibleBook(16, "Nehemías", "Ne", "Neh.", false),
  new BibleBook(17, "Ester", "Est", "Est.", false),
  new BibleBook(18, "Job", "", "", false),
  ...
  new BibleBook(22, "El Cantar de los Cantares", "Can", "Cant.", false),
  new BibleBook(23, "Isaías", "Is", "Isa", false),
  new BibleBook(23, "", "Is.", "", false),
  new BibleBook(24, "Jeremías", "Jer", "Jer.", false),
  new BibleBook(25, "Lamentaciones", "Lam", "Lam.", false),
  new BibleBook(26, "Ezequiel", "Eze", "Ezeq.", false),
  new BibleBook(27, "Daniel", "Da", "Dan.", false),
  new BibleBook(28, "Oseas", "Os", "Os.", false),
  new BibleBook(29, "Joel", "Joe", "", false),
  new BibleBook(30, "Amós", "Am", "", false),
  new BibleBook(31, "Abdías", "Abd", "Abd.", true),
  new BibleBook(32, "Jonás", "Jon", "Jon.", false),
  new BibleBook(33, "Miqueas", "Miq", "Miq.", false),
  new BibleBook(34, "Nahúm", "Na", "Nah.", false),
  new BibleBook(35, "Habacuc", "Hab", "Hab.", false),
  new BibleBook(36, "Sofonías", "Sof", "Sof.", false),
  new BibleBook(37, "Ageo", "Ag", "", false),
  new BibleBook(38, "Zacarías", "Zac", "Zac.", false),
  new BibleBook(39, "Malaquías", "Mal", "Mal.", false),
  ...
  new BibleBook(46, "1 Corintios", "1Co", "1 Cor.", false),
  new BibleBook(47, "2 Corintios", "2Co", "2 Cor.", false),
  new BibleBook(48, "Gálatas", "Gál", "Gál.", false),
  new BibleBook(49, "Efesios", "Ef", "Efes.", false),
  new BibleBook(50, "Filipenses", "Flp", "Filip.", false),
  new BibleBook(51, "Colosenses", "Col", "Col.", false),
  new BibleBook(52, "1 Tesalonicenses", "1Te", "1 Tes.", false),
  new BibleBook(53, "2 Tesalonicenses", "2Te", "2 Tes.", false),
  new BibleBook(54, "1 Timoteo", "1Ti", "1 Tim.", false),
  new BibleBook(55, "2 Timoteo", "2Ti", "2 Tim.", false),
  ...
  new BibleBook(60, "1 Pedro", "1Pe", "1 Ped.", false),
  new BibleBook(61, "2 Pedro", "2Pe", "2 Ped.", false),
      ...
      if (Array.isArray(bibleText)) {
        for (let m = 0; m < bibleText.length; m++) {
          ...
          if (isSingleChapter) {
            ...
            let validChapters = bibleText[0].match(/[/0-9]+:\d/g).join();
            chapters = validChapters.match(/[0-9]+:/g);
        ...
        if (isSingleChapter) {
          ...
          let validChapters = bibleText.match(/[/0-9]+:\d/g).join();
          chapters = validChapters.match(/[0-9]+:/g);
          if (chapters.length == 1) {
            chapters[0] = chapters[0].replace(":", "");
            chapters[1] = chapters[0];
